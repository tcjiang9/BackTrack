...
public class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private static String DB_PATH = "/data/data/io.intrepid.nostalgia/databases/";
        ...
        private void copyDataBase() throws IOException{
            ...
            InputStream myInput = myContext.getAssets().open("tracks.db");
    ...
    public Cursor getData() {
        ...
        return myDataBase.rawQuery("SELECT * FROM tracks", null);
